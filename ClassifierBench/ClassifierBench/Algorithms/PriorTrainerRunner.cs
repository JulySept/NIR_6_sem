...
public class PriorTrainerRunner(MLContext mlContext) : IAlgorithmRunner
{
    ...
    private readonly IEstimator<ITransformer> _estimator = mlContext.BinaryClassification.Trainers.Prior();
    private bool _isModelTrained = false;
    public string Name => "Prior";
